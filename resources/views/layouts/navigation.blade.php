<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link class="border-t" :href="route('logout')" onclick="event.preventDefault();
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1 px-4 flex justify-between">
                <a href="{{ route('transactions.index') }}" class="py-2" title="Sua carteira">
                    <div class="flex items-center">
                        <span class="mr-1 text-xs">R${{ number_format(auth()->user()->balance, 2, ',', '.')
                            }}</span>
                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                ...
                <a href="{{ route('notifications.index') }}" class="relative py-2" title="Notificações">
                    <livewire:notification-tracker :countUnreadNotifications="auth()->user()->unreadNotifications()->count()" />
                ...
                <a href="{{ route('talks.index') }}" class="py-2" title="Suas conversas">
                    <span class="svg-icon svg-icon-primary svg-icon-2x">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24" />
