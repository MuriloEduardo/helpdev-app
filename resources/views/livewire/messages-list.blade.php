<div>
    ...
    <div @class([ 'text-right'=> $message->user_id === auth()->id(),
        ...
        <div @class([ 'inline-block	bg-white rounded p-3 overflow-hidden shadow-sm sm:rounded-lg border-b border-gray-200' , 'bg-gray-600 text-white'=> $message->user_id === auth()->id(),
            ])>
